...
//sub components
export { default as Ads } from '../components/subcomponents/Ads';
export { default as Followed } from '../components/subcomponents/Followed';
export { default as Pages } from '../components/subcomponents/Pages';
